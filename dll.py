...
class DLL:
    ...
    def remove(self, data):
        ...
        The time complexity is 0(n) because in the worst case, we have to visit every Node before finding the one we want to remove.
        """
        if self.head is None:
...
# Consider adding index() and insert() methods