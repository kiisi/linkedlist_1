class SLLNode:
    ...
    def set_data(self, new_data):
        """Replace the existing value of the self.data attribute with the new_data"""
        self.data = new_data
    ...
    def set_next(self, new_next):
        """Replace the existing value of the self.next attribute with the new_next"""
        self.next = new_next
...
class SLL:
    ...
    def search(self, data):
        """
        Traverses the Linked List and returns True if the data searched for is present in one of the Nodes. Otherwise in one Nodes. Otherwise, it returns False.
    ...
    def remove(self, data):
        ...
        The time complexity is 0(n) because in the worst case we have to visit every Node before we find a the one we need to remove
        """
        if self.head is None:
